...
iadddocumentation   -name Description -text "Xilinx XPS TFT Controller"
  ...
  imodeladdmmregister   -name CR   -offset 4  -width 32 -access rw -readfunction readReg -writefunction writeReg -userdata 1
  ...
  imodeladdmmregister   -name IESR -offset 8  -width 32 -access rw -readfunction readReg -writefunction writeReg -userdata 2
  ...
  imodeladdmmregister   -name CCR  -offset 12 -width 32 -access rw -readfunction readReg -writefunction writeReg -userdata 3
